...
const Apitext = () => {
  const options = {
    ...
    headers: {
      ...
      Authorization: "Basic trillionaireautoparts:Ikarikar123@@",
      "dhl-api-key": "apE7wU7iZ4lP3n",
      "Access-Control-Allow-Origin": "*", // Update this to the actual origin of your frontend
