...
const nextConfig = {
  ...
  images: {
    domains: ['localhost', 'https://ngmp-products.s3.us-east-005.backblazeb2.com', 'https://admin.nilegmp.com', '192.168.1.16'], // Add the IP address to the list of allowed domains
    remotePatterns: [
      {
        protocol: "https",
      ...
      {
        protocol: "https",
        hostname: "192.168.1.16", // Replace with the actual hostname or IP address
