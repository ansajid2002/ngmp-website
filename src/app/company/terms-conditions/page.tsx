    ...
    <div className="px-5 lg:px-40 p-10 space-y-8 lg:space-y-12">
      ...
      <div className="space-y-1">
        ...
        <p className="lg:text-lg">
          ...
          faith.
          <br />
          The platform prohibits the listing and exchange of illegal items,
          counterfeit goods, and services that violate intellectual property
          rights or local laws.
        </p>
      </div>
      ...
      <div className="space-y-1">
        ...
        <p className="lg:text-lg">
          ...
          <br />
          The platform provides tools to assist in this communication and
          resolution process.
        </p>
      </div>
      ...
      <div className="space-y-1">
        ...
        <p className="lg:text-lg">
          ...
          <br />
          Our team will review the case, requiring both parties to submit
          evidence, such as transaction records, communication logs, and any
      ...
      <div className="space-y-1">
        ...
        <p className="lg:text-lg">
          ...
          <br />
          We aim to resolve disputes impartially and fairly, considering all
      ...
      <div className="space-y-1">
        ...
        <p className="lg:text-lg">
          ...
          <br />
          Nile Global Marketplace is not responsible for the assessment or
          guarantee of the quality, safety, or legality of items listed.
        </p>
      </div>
      ...
      <div className="space-y-1">
        ...
        <p className="lg:text-lg">
          ...
          restocking fee.
          <br />
          Refunds, when processed, are provided in Nile Money and reflect the
      ...
      <div className="space-y-1">
        ...
        <p className="lg:text-lg">
          ...
          <br />
          We maintain the right to enforce these sanctions to ensure platform
