...
import { UserOutlined, LockOutlined, MailOutlined, PhoneOutlined, FlagOutlined } from '@ant-design/icons';
                    ...
                    >
                        ...
                        <Form.Item className='flex justify-center w-full'>
                            <Button
                                type="default"
                                htmlType="submit"
                                className={`w-full flex justify-center items-center bg-indigo-600 text-white py-2 rounded-md ${loading ? 'opacity-50 cursor-not-allowed' : 'hover:bg-indigo-500'}`}
                                loading={loading}
                            >
