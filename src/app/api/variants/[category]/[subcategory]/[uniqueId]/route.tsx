...
// app/api/variants/[category]/[subcategory]/[uniqueId]/route.ts

export async function GET(request: Request, { params }: { params: { category: string, subcategory: string, uniqueId: number } }) {
